...
const unsigned int Num_channels = 24;  //Number of channels to read (Here, it is 24 cells, plus measurements at cells 6,12,18 and 24)
const unsigned int Num_buffs = 8;      //Number of data buffers
const uint8_t CS_pins[Num_channels / 4] = { 19, 20, 9, 10, 16, 17 };
